...
//       try {
//         const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/onebd/`, {
//           cache: "no-store",
//         });
//         if (res.ok) {
...
//         }
//       } catch (err) {
//         console.error("Error fetching one bedroom houses:", err);
//       }
//     };
...
//               <Link href="/">Home</Link>
//             </li>
//             <li className="breadcrumb-item active text-danger">One Bedroom</li>
//           </ol>
//         </div>
//       </div>
